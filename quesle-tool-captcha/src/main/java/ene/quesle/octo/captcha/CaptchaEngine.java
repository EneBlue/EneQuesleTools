...
public class CaptchaEngine extends ListImageCaptchaEngine {
	...
	/** 随机背景图片路径 */
	private static final String BACKGROUND_IMAGE_PATH = "image";
	...
	protected void buildInitialFactories() {
		...
		BackgroundGenerator backgroundGenerator = new FileReaderRandomBackgroudGeneratorOverride(IMAGE_WIDTH, IMAGE_HEIGHT, new ClassPathResource(BACKGROUND_IMAGE_PATH).getPath());
		//BackgroundGenerator backgroundGenerator = new GradientBackgroundGenerator(IMAGE_WIDTH, IMAGE_HEIGHT, getRandColor(100, 255), getRandColor(100, 255));
